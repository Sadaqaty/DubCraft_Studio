...
def convert_audio_format(input_path: str, output_path: str, codec: str = 'pcm_s16le') -> bool:
    """
...
def separate_background_music(audio_path: str, out_voice_path: str, out_bgm_path: str) -> bool:
    """
